export const removeVectorTileLayer = (map) => {
  for (const layer of vectorMapStyle.layers) {
...
export const vectorMapStyle = {
  ...
  fog: {
    ...
    "horizon-blend": ["interpolate", ["exponential", 1.2], ["zoom"], 4, 0.01, 6, 0.1],
    "star-intensity": ["interpolate", ["exponential", 1.2], ["zoom"], 4, 0.1, 6, 0],
  },
  ...
  layers: [
    ...
    },
    {
      ...
      paint: {
        ...
        "fill-opacity": ["interpolate", ["exponential", 1.5], ["zoom"], 8, 0.8, 12, 0],
    ...
    },
    {
      ...
      paint: {
        ...
        "line-width": ["interpolate", ["exponential", 1.5], ["zoom"], 9, 1, 14, 8],
        "line-blur": ["interpolate", ["exponential", 1.5], ["zoom"], 9, 1, 14, 8],
      },
      metadata: {
        "mapbox:featureComponent": "land-and-water",
        "mapbox:group": "Land & water, land",
    ...
    },
    {
      ...
      paint: {
        "fill-color": [
          ...
          16,
          ["match", ["get", "class"], "shadow", "hsla(66, 38%, 17%, 0)", "hsla(60, 20%, 95%, 0)"],
        ],
        "fill-antialias": false,
      },
    ...
    },
    {
      ...
      metadata: { "mapbox:featureComponent": "terrain", "mapbox:group": "Terrain, surface" },
    },
    {
      id: "ferry",
      type: "line",
    ...
    },
    {
      ...
      paint: { "fill-color": "hsl(0, 0%, 95%)", "fill-outline-color": "hsl(60, 10%, 70%)" },
      metadata: {
        "mapbox:featureComponent": "road-network",
    ...
    },
    {
      ...
      paint: {
        ...
        "line-color": [
          ...
          9,
          ["match", ["get", "class"], "motorway", "hsl(15, 100%, 75%)", "hsl(35, 89%, 75%)"],
        ],
        "line-opacity": ["interpolate", ["linear"], ["zoom"], 3, 0, 3.5, 1],
      },
      metadata: {
    ...
    },
    {
      ...
      metadata: { "mapbox:featureComponent": "terrain", "mapbox:group": "Terrain, terrain-labels" },
    },
    {
    ...
    },
    {
      ...
      paint: { "text-color": "hsl(205, 43%, 90%)", "text-halo-color": "hsla(60, 17%, 84%, 0.5)" },
      metadata: {
  ...
  sources: {
    composite: {
      ...
      data: {
        ...
        center: [0, 0, 0],
        constituents: [
          { maxzoom: 16, minzoom: 0, source: "mapbox.mapbox-streets-v8" },
          { maxzoom: 15, minzoom: 0, source: "mapbox.mapbox-terrain-v2" },
          { maxzoom: 7, minzoom: 0, source: "mapbox.mapbox-bathymetry-v2" },
        ],
        fillzoom: 9,
        format: "pbf",
        language_options: {
        ...
        vector_layers: [
          { id: "landuse", minzoom: 5, source: "mapbox.mapbox-streets-v8" },
          { id: "waterway", minzoom: 7, source: "mapbox.mapbox-streets-v8" },
          { id: "water", minzoom: 0, source: "mapbox.mapbox-streets-v8" },
          { id: "aeroway", minzoom: 9, source: "mapbox.mapbox-streets-v8" },
          { id: "structure", minzoom: 13, source: "mapbox.mapbox-streets-v8" },
          { id: "building", minzoom: 12, source: "mapbox.mapbox-streets-v8" },
          { id: "landuse_overlay", minzoom: 5, source: "mapbox.mapbox-streets-v8" },
          { id: "road", minzoom: 3, source: "mapbox.mapbox-streets-v8" },
          { id: "admin", minzoom: 0, source: "mapbox.mapbox-streets-v8" },
          { id: "place_label", minzoom: 0, source: "mapbox.mapbox-streets-v8" },
          { id: "airport_label", minzoom: 8, source: "mapbox.mapbox-streets-v8" },
          { id: "transit_stop_label", minzoom: 5, source: "mapbox.mapbox-streets-v8" },
          { id: "natural_label", minzoom: 0, source: "mapbox.mapbox-streets-v8" },
          { id: "poi_label", minzoom: 6, source: "mapbox.mapbox-streets-v8" },
          { id: "motorway_junction", minzoom: 9, source: "mapbox.mapbox-streets-v8" },
          { id: "housenum_label", minzoom: 16, source: "mapbox.mapbox-streets-v8" },
          { id: "landcover", maxzoom: 22, minzoom: 0, source: "mapbox.mapbox-terrain-v2" },
          { id: "hillshade", maxzoom: 22, minzoom: 0, source: "mapbox.mapbox-terrain-v2" },
          { id: "contour", maxzoom: 22, minzoom: 0, source: "mapbox.mapbox-terrain-v2" },
          { id: "depth", maxzoom: 7, minzoom: 0, source: "mapbox.mapbox-bathymetry-v2" },
        ],
