...
export const createMap = ({
  ...
  map.on('load', () => {
    const viewPopup = new window.mapboxgl.Popup({ closeButton: false, maxWidth: 400 });
    const editPopup = new window.mapboxgl.Popup({ closeButton: false, maxWidth: 440 });

    if (mapsStore.primary?.url) {
