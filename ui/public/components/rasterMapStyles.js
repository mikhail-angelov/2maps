  ...
  layers: [
    ...
    },
    {
      ...
      filter: [
        ...
        [
          "all",
          ["match", ["get", "mode"], "rail", true, "metro_rail", true, "light_rail", true, false],
          ["!=", ["get", "stop_type"], "entrance"],
        ],
        16,
        [
  ...
  sources: {
    "mapbox-satellite": {
      ...
      data: {
        ...
        scheme: "xyz",
        tilejson: "3.0.0",
        tiles: ["mapbox://tiles/mapbox.satellite/{z}/{x}/{y}.png"],
    ...
    composite: {
      ...
      data: {
        ...
        webpage: "https://studio.mapbox.com/tilesets/mapbox.mapbox-streets-v8",
